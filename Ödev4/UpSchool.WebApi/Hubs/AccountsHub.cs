...
public class AccountsHub:Hub
{
    ...
    public async Task<bool> DeleteAsync(Guid accountId)
    {
        ...
        await  Clients.AllExcept(Context.ConnectionId).SendAsync(SignalRMethodKeys.Accounts.Deleted,accountId);         // Connection yapan kişi hariç herkese mesaj gönderiliyor.
